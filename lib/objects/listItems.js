  ...
  var doRequest = require('../util/doRequest')(client),
    ...
    crudl = {
      ...
      byteStream: function(floderName, filename, cb) {
        var host = var host = client.BASE_LIST_URL.substring(0,client.BASE_LIST_URL.indexOf('_api/'))+ "/_api/web/GetFolderByServerRelativeUrl('" + floderName + "')/Files('" + filename + "')/$value";
