...
module.exports = function(client){
  ...
  crudl = {
    ...
    list : function(listId, cb){
      ...
      //FieldValuesAsText is not supported here by Sharepoint, Append filterFields and / or selectFields to host
      host = urlBuilder.augmentURL(host, false, client.filterFields, client.selectFields);
    ...
    read : function(listId, itemId, cb){
      ...
      //Append fieldValuesAsText (filters are not supported by Sharepoint at the item level) and / or selectFields to host 
      host = urlBuilder.augmentURL(host, client.fieldValuesAsText, null, client.selectFields);
