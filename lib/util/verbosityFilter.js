...
verbosityFilters = {
  ...
  "lists" : { type : 'pick', fields : ['ImageUrl', 'LastItemDeletedDate', 'LastItemModifiedDate', 'ListItemEntityTypeFullName', 'ItemCount'] },
  "list" : { type : 'pick', fields : ['DocumentTemplateUrl', 'EntityTypeName', 'ImageUrl', 'LastItemDeletedDate', 'LastItemModifiedDate', 'ListItemEntityTypeFullName', 'TemplateFeatureId', 'ItemCount'] },
  "fields" : { type : 'omit', fields : ['SchemaXml', 'File'] },
  "listitem" : { type : 'omit', fields : [] },
  "listitems" : { type : 'omit', fields : [] },
